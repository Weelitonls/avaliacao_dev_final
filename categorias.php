          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg order-lg-first">
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                ...
                <li class="nav-item">
                  <a href="./categorias.php" class="nav-link active"><i class="fe fe-package"></i> Categorias</a>
                </li>
              </ul>
            </div>
          </div>
                      ...
                      <tbody>
                        ...
                        $Coluna = '
                          <tr>
                            ...
                            <td>%s</td>
                            <td>
                              <a class="icon" title="Alterar a Categoria" href="./form-categoria.php?categoria=%s">
                                <i class="fe fe-edit"></i>
                              </a>
                            </td>
                            <td>
                              <a class="icon" title="Excluir Categoria" href="javascript:void(0)" onclick="RemoverCategoria(%s)">
