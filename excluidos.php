...
<head>
  ...
  <title>NorthWind - Produtos Excluidos</title>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg order-lg-first">
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                ...
                <li class="nav-item">
                  <a href="./excluidos.php" class="nav-link active"><i class="fe fe-trash"></i> Lixeira</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Produtos excluidos</h3>
                  <div id="alerta" class="card-options"></div>
                </div>
                      ...
                      <tbody>
                        ...
                        $Coluna = '
                          <tr>
                            ...
                            <td>
                              <a class="icon" href="javascript:void(0)" title="Restaurar Produto" onclick="Restaurar(%s);">
